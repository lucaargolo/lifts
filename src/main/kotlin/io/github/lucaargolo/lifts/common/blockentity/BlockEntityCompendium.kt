...
object BlockEntityCompendium: RegistryCompendium<BlockEntityType<*>>(Registry.BLOCK_ENTITY_TYPE) {
    ...
    val STIRLING_LIFT_TYPE = register("stirling_lift", BlockEntityType.Builder.create( { StirlingLiftBlockEntity(null) }, BlockCompendium.STIRLING_LIFT ).build(null)) as BlockEntityType<StirlingLiftBlockEntity>
    val ELECTRIC_LIFT_TYPE = register("electric_lift", BlockEntityType.Builder.create( { ElectricLiftBlockEntity(null, 0.0, EnergyTier.INFINITE) }, BlockCompendium.ELECTRIC_LIFT_MK1, BlockCompendium.ELECTRIC_LIFT_MK2, BlockCompendium.ELECTRIC_LIFT_MK3, BlockCompendium.ELECTRIC_LIFT_MK4, BlockCompendium.ELECTRIC_LIFT_MK5 ).build(null)) as BlockEntityType<ElectricLiftBlockEntity>
