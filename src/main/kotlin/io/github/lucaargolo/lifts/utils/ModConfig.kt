...
class ModConfig {
    ...
    class LiftConfigs(
        ...
        val electricLiftMk1: ElectricLiftConfig = ElectricLiftConfig(1.2, 32, 32000),
        val electricLiftMk2: ElectricLiftConfig = ElectricLiftConfig(1.4, 64, 64000),
        val electricLiftMk3: ElectricLiftConfig = ElectricLiftConfig(1.6, 128, 128000),
        val electricLiftMk4: ElectricLiftConfig = ElectricLiftConfig(1.8, 128, 256000),
        val electricLiftMk5: ElectricLiftConfig = ElectricLiftConfig(2.0, 256, 512000)
    )
